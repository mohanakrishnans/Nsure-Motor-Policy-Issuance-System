! function(e, t, n) {
        ...
        function e(e, n) {
            ...
            function g(e, o, r, a) {
                ...
                for (var d = u(o);;) {
                    ...
                    var c = d + (e ? -1 : 1),
                        l = null;
                    if (i(c) ? l = E[c] : n && (l = e ? f() : p(), c = u(l)), null === l || c === a) return null;
                    if (r(l)) return l;
    ...
    function() {
        function e(e, n, o) {
            ...
            var u = {},
                ...
                p = {},
                f = {};
            return r.getResponsiveAttribute = l, r.getQuery = c, r.watchResponsiveAttributes = s, r
        }
        t.module("material.core").factory("$mdMedia", e), e.$inject = ["$mdConstant", "$rootScope", "$window"]
    }(),
    function() {
        function o(o, i, a, d, c, l, s) {
            function m(e) {
                return e[0] || e
            }
            var u = l.startSymbol(),
                ...
                f = {
                    ...
                    findFocusTarget: function(e, n) {
                        var o, r = e[0].querySelectorAll(n || "[md-autofocus]");
                        return r.length && t.forEach(r, function(e) {
                            e = t.element(e);
                            var n = e[0].getAttribute("md-autofocus"),
                                r = n ? e.scope().$eval(n) !== !1 : !0;
                            r && (o = e)
                        }), o
                    },
                    disableScrollAround: function(e, n) {
                        ...
                        return f.disableScrollAround._enableScrolling = function() {
                            --f.disableScrollAround._count || (c(), l(), delete f.disableScrollAround._enableScrolling)
                        }
                    },
                    ...
                    extractElementByName: function(e, n) {
                        for (var o = 0, r = e.length; r > o; o++)
                            if (e[o].nodeName.toLowerCase() === n) return t.element(e[o]);
                        return s.warn(f.supplant("Unable to find node '{0}' in element.", [n])), e
                    },
                    ...
                    nextTick: function(e, t) {
                        ...
                        var o = f.nextTick,
                            r = o.timeout,
                            a = o.queue || [];
                        return a.push(e), null == t && (t = !0), o.digest = o.digest || t, o.queue = a, r || (o.timeout = i(n, 0, !1))
                    },
    ...
    function() {
        function e(e, n, o, r, i, a) {
            this.compile = function(d) {
                ...
                }), t.extend(u, h), u.$template = c ? n.get(c, {
                    cache: a
                }).then(function(e) {
                    return e.data
    ...
    function() {
        ...
        function o(n, o, r) {
            ...
            return h.isHijackingClicks && h.handler("click", {
                ...
                onMove: function(e, t) {
                    var n, o;
                    e.preventDefault(), this.state.dragPointer ? this.dispatchDragMove(e) : (this.state.options.horizontal ? (n = Math.abs(t.distanceX) > this.state.options.minDistance, o = Math.abs(t.distanceY) > this.state.options.minDistance * this.state.options.cancelMultiplier) : (n = Math.abs(t.distanceY) > this.state.options.minDistance, o = Math.abs(t.distanceX) > this.state.options.minDistance * this.state.options.cancelMultiplier), n ? (this.state.dragPointer = d(e), s(e, this.state.dragPointer), this.dispatchEvent(e, "$md.dragstart", this.state.dragPointer)) : o && this.cancel())
                },
                dispatchDragMove: o.throttle(function(e) {
                    this.state.isRunning && (s(e, this.state.dragPointer), this.dispatchEvent(e, "$md.drag", this.state.dragPointer))
                }),
                onEnd: function(e, t) {
                    this.state.dragPointer && (s(e, this.state.dragPointer), this.dispatchEvent(e, "$md.dragend", this.state.dragPointer))
                }
            }).handler("swipe", {
                options: {
                    minVelocity: .65,
        ...
        function a(e, n) {
            ...
            function i(e) {
                u && c(e, u) && (s(e, u), o("move", e))
            }

            function a(e) {
                u && c(e, u) && (s(e, u), u.endTime = +Date.now(), o("end", e), h = u, u = null)
            }
    ...
    function() {
        function e() {
            function e(e) {
                ...
                function i(n, o) {
                    function r(e) {
                        return e = e || {}, e._options && (e = e._options), s.show(t.extend({}, l, e))
                    }

                    function i(t, n) {
                        var r = {};
                        return r[e] = m, o.invoke(t || function() {
                            return n
                        }, {}, r)
                    }
                    var a, l, s = n(),
                    ...
                    return a = c.methods || [], l = i(c.optionsFactory, {}), t.forEach(d, function(e, t) {
                        m[t] = e
                    }), t.forEach(c.presets, function(e, n) {
                        function o(e) {
                            this._options = t.extend({}, r, e)
                        }
                        var r = i(e.optionsFactory, {}),
                            d = (e.methods || []).concat(a);
                        if (t.extend(r, {
                                $type: n
                            ...
                            var c = "show" + n.charAt(0).toUpperCase() + n.slice(1);
                            m[c] = function(e) {
                                var t = m[n](e);
                                return m.show(t)
                            }
                ...
                }), i.$inject = ["$$interimElement", "$injector"], l
            }

            function o(e, o, r, i, a, d, c, l, s, m) {
                return function() {
                    function m(e) {
                        e = e || {};
                        var t = new p(e),
                            n = !e.skipHide && E.length ? f.hide() : o.when(!0);
                        return n["finally"](function() {
                            E.push(t), t.show()["catch"](function(e) {})
                        }), t.deferred.promise
                    }

                    function u(e, t) {
                        function r(t) {
                            return t.remove(e || b, !1)["catch"](function(e) {}), t.deferred.promise
                        }
                        if (!E.length) return o.when(e || b);
                        if (t = t || {}, t.closeAll) {
                            var i = o.all(E.reverse().map(r));
                            return E = [], i
                        }
                        if (t.closeTo !== n) return o.all(E.splice(t.closeTo).map(r));
                        var a = E.pop();
                        return r(a)
                    }
                    ...
                    function h(e) {
                        var t = E.shift();
                        return t ? (t.remove(e || g, !0)["catch"](function(e) {}), t.deferred.promise) : o.when(e || g)
                    }
                    ...
                    function p(m) {
                        function u() {
                            return o(function(e, t) {
                                ...
                                g(m).then(function(t) {
                                    C = b(t, m), A = M(C, m, t.controller).then(e, n)
                                })
                            })
                        }

                        function h(e, t) {
                            return m.cancelAutoHide && m.cancelAutoHide(), o(function(n, r) {
                                function i() {
                                    y.deferred.resolve(e), n(e)
                                }

                                function a(e) {
                                    y.deferred.reject(e), r(e)
                                }
                                o.when(A)["finally"](function() {
                                    m.element.triggerHandler("$mdInterimElementRemove"), $(m.element, m).then(function() {
                                        t && a(e) || i()
                                    }, a)
                                })
                            })
                        ...
                        function b(e, n) {
                            ...
                            return n.element = o, n.parent = E(o, n), n.themable && s(o), o
                        }

                        function E(n, o) {
                            var r = o.parent;
                            if (r = t.isFunction(r) ? r(o.scope, n, o) : t.element(t.isString(r) ? e[0].querySelector(r) : r), !(r || {}).length) {
                                var i;
                                return a[0] && a[0].querySelector && (i = a[0].querySelector(":not(svg) > body")), i || (i = a[0]), "#comment" == i.nodeName && (i = e[0].body), t.element(i)
                            }
                            return r
                        }
                        ...
                        function v() {
                            var e, o = t.noop;
                            m.hideDelay && (e = i(f.hide, m.hideDelay), o = function() {
                                i.cancel(e)
                        ...
                        function $(e, n) {
                            ...
                            return o(function(t, i) {
                                try {
                                    var a = o.when(e ? n.onRemove(n.scope, e, n) : !0);
                                    r(e, a), a.then(function() {
                                        !n.preserveScope && n.scope.$destroy(), t(e)
                                    }, i)
                                } catch (d) {
                                    i(d.message)
                                }
            ...
            return e.$get = o, o.$inject = ["$document", "$q", "$rootScope", "$timeout", "$rootElement", "$animate", "$mdUtil", "$mdCompiler", "$mdTheming", "$log"], e
        }
    ...
    function() {
        ! function() {
            function e(e, t) {
                function n(n, o, r) {
                    var i = r.$normalize(e);
                    if (t && o.addClass(e), r[i] && o.addClass(e + "-" + r[i].replace(/\s+/g, "-")), n) {
                        var a;
                        r.$observe(function() {
                            return r[e]
                        }, function(t) {
                            o.removeClass(a), a = e + "-" + String(t).replace(/\s+/g, "-"), o.addClass(a)
                        })
                    }
                }
                return function() {
    ...
    function() {
        ...
        e.$inject = ["$mdButtonInkRipple", "$mdCheckboxInkRipple"], n.$inject = ["$injector"], o.$inject = ["$scope", "$element", "rippleOptions", "$window", "$timeout", "$mdUtil"], o.prototype.getColor = function(e) {
            ...
            e.hasOwnProperty("originalEvent") && (e = e.originalEvent), this.mousedown = !0, this.options.center ? this.createRipple(this.container.prop("clientWidth") / 2, this.container.prop("clientWidth") / 2) : this.createRipple(e.layerX, e.layerY)
            ...
            var a = this,
                ...
                s = 2 * Math.max(Math.abs(c - e), e),
                m = 2 * Math.max(Math.abs(l - n), n),
                u = r(this.options.fitRipple, s, m);
            d.css({
                left: e + "px",
                top: n + "px",
                background: "black",
    ...
    function() {
        function e(e) {
            function o(e, t) {
                return t = t || {}, s[e] = a(e, t), b
            }

            function r(e, n) {
                return a(e, t.extend({}, s[e] || {}, n))
            }
                ...
                o.name = e, o.colors = {}, o.dark = n, n(!1), M.forEach(function(e) {
                    ...
                    o[e + "Palette"] = function(r, i) {
                        ...
                        return Object.keys(a.hues).forEach(function(e) {
                            ...
                            if (-1 == A.indexOf(t)) throw new Error("Invalid hue value '%1' in theme %2's %3 color %4. Available hue values: %5".replace("%1", t).replace("%2", o.name).replace("%3", e).replace("%4", r).replace("%5", A.join(", ")))
                        }), o
                    }, o[e + "Color"] = function() {
            ...
            var b, E = "default",
                v = !1;
            return t.extend(s, e), u.$inject = ["$rootScope", "$log"], b = {
                definePalette: o,
                extendPalette: r,
                theme: d,
        ...
        function i(e, n, o) {
            ...
            return o = o.replace(m, function(t, n, o, r, i) {
                return "foreground" === n ? "shadow" == o ? e.foregroundShadow : e.foregroundPalette[o] || e.foregroundPalette[1] : (0 === o.indexOf("hue") && (o = e.colors[n].hues[o]), l((s[e.colors[n].name][o] || "")[i ? "contrast" : "value"], r))
        ...
        function a(e) {
            function n(e) {
                ...
                "string" == typeof o && (o = o.split(" ")), "string" == typeof r && (r = r.split(" ")), "string" == typeof i && (i = i.split(" ")), delete e.contrastDefaultColor, delete e.contrastLightColors, delete e.contrastStrongLightColors, delete e.contrastDarkColors, t.forEach(e, function(a, d) {
                    ...
                    if (!t.isObject(a)) {
                        var s = c(a);
                        if (!s) throw new Error("Color %1, in palette %2's hue %3, is invalid. Hex or rgb(a) color expected.".replace("%1", a).replace("%2", e.name).replace("%3", d));
                        e[d] = {
                            value: s,
                            contrast: l()
                        }
        ...
        var A = ["50", "100", "200", "300", "400", "500", "600", "700", "800", "900", "A100", "A200", "A400", "A700"];
        ...
        function e(e, n, o, r, i) {
            ...
            return a = {
                ...
                calculateZoomToOrigin: function(n, o) {
                    ...
                    if (r) {
                        var l = a.clientRect(r) || a.copyRect(o.bounds),
                            s = a.copyRect(n[0].getBoundingClientRect()),
                            m = a.centerPointFor(s),
                            u = a.centerPointFor(l);
                        c = d({
                            centerX: u.x - m.x,
                            centerY: u.y - m.y,
                            scaleX: Math.round(100 * Math.min(.5, l.width / s.width)) / 100,
                            scaleY: Math.round(100 * Math.min(.5, l.height / s.height)) / 100
                        })
                    }
                    return c
                },
    ...
    function() {
        t.version.minor >= 4 ? t.module("material.core.animate", []) : ! function() {
            ...
            var r = t.forEach,
                i = e.ontransitionend === n && e.onwebkittransitionend !== n,
                a = i ? "-webkit-" : "",
                d = (i ? "webkitTransitionEnd " : "") + "transitionend",
                c = (i ? "webkitAnimationEnd " : "") + "animationend",
                ...
                m = ["$q", "$$rAFMutex", function(e, n) {
                    ...
                    return o.prototype = {
                        ...
                        _resolve: function(e) {
                            this._state !== d && (r(this._doneCallbacks, function(t) {
                                t(e)
                            }), this._doneCallbacks.length = 0, this._state = d)
                        }
                    }, o
                }];
            t.module("material.core.animate", []).factory("$$forceReflow", l).factory("$$AnimateRunner", m).factory("$$rAFMutex", s).factory("$animateCss", ["$window", "$$rAF", "$$AnimateRunner", "$$forceReflow", "$$jqLite", "$timeout", function(e, t, n, l, s, m) {
                function u(t, i) {
                    var l = [],
                        s = M(t);
                    i.transitionStyle && l.push([a + "transition", i.transitionStyle]), i.keyframeStyle && l.push([a + "animation", i.keyframeStyle]), i.delay && l.push([a + "transition-delay", i.delay + "s"]), i.duration && l.push([a + "transition-duration", i.duration + "s"]);
                    var u = i.keyframeStyle || i.to && (i.duration > 0 || i.transitionStyle),
                        f = !!i.addClass || !!i.removeClass,
                        y = u || f;
                    $(t, !0), E(t, i);
                    var C, A, T = !1;
                    return {
                        ...
                        start: function() {
                            function e() {
                                return T ? void 0 : (T = !0, C && A && t.off(C, A), h(t, i), b(t, i), r(l, function(e) {
                                    s.style[o(e[0])] = ""
                                }), u.complete(!0), u)
                            }
                            var u = new n;
                            return g(function() {
                                ...
                                var n = p(t);
                                if (0 === n.duration) return e();
                                var u = [];
                                i.easing && (n.transitionDuration && u.push([a + "transition-timing-function", i.easing]), n.animationDuration && u.push([a + "animation-timing-function", i.easing])), i.delay && n.animationDelay && u.push([a + "animation-delay", i.delay + "s"]), i.duration && n.animationDuration && u.push([a + "animation-duration", i.duration + "s"]), r(u, function(e) {
                                    var t = e[0],
                                        n = e[1];
                                    s.style[o(t)] = n, l.push(e)
                                });
                                var f = n.delay,
                                    g = 1e3 * f,
                                    b = n.duration,
                                    E = 1e3 * b,
                                    M = Date.now();
                                C = [], n.transitionDuration && C.push(d), n.animationDuration && C.push(c), C = C.join(" "), A = function(t) {
                                    t.stopPropagation();
                                    var n = t.originalEvent || t,
                                        o = n.timeStamp || Date.now(),
                                        r = parseFloat(n.elapsedTime.toFixed(3));
                                    Math.max(o - M, 0) >= g && r >= b && e()
                                }, t.on(C, A), v(t, i), m(e, g + 1.5 * E, !1)
                            }), u
                        }
                    }
                }
                ...
                function h(e, t) {
                    t.addClass && (s.addClass(e, t.addClass), t.addClass = null), t.removeClass && (s.removeClass(e, t.removeClass), t.removeClass = null)
                }

                function p(t) {
                    function n(e) {
                        return i ? "Webkit" + e.charAt(0).toUpperCase() + e.substr(1) : e
                    }
                    var o = M(t),
                        r = e.getComputedStyle(o),
                        a = f(r[n("transitionDuration")]),
                        d = f(r[n("animationDuration")]),
                        c = f(r[n("transitionDelay")]),
                        l = f(r[n("animationDelay")]);
        ...
        function n(e) {
            function n(e, n, i, a, d, c, l) {
                function s(o, r, l, s) {
                    ...
                    }), a.inherit(h, l.parent), e.enter(h, l.parent, null);
                    var m = new u(r, l.parent);
                    return l.bottomSheet = m, l.targetEvent && t.element(l.targetEvent.target).blur(), a.inherit(m.element, l.parent), l.disableParentScroll && (l.restoreScroll = i.disableScrollAround(m.element, l.parent)), e.enter(m.element, l.parent).then(function() {
                ...
                function u(e, t) {
                    ...
                    var m = l.register(t, "drag", {
                        horizontal: !1
                    });
                    return t.on("$md.dragstart", a).on("$md.drag", c).on("$md.dragend", s), {
                        element: e,
                        cleanup: function() {
                            m(), t.off("$md.dragstart", a), t.off("$md.drag", c), t.off("$md.dragend", s)
                        }
                    }
                }
                var h;
    ...
    function() {
        function e(e, n, o, r) {
            ...
            function d(a, d, c) {
                ...
                s || o.expect(d, "aria-label"), i(c) && t.isDefined(c.ngDisabled) && a.$watch(c.ngDisabled, function(e) {
    ...
    function() {
        function e(e, n, o, r, i, a) {
            function d(d, l) {
                return l.type = "checkbox", l.tabindex = l.tabindex || "0", d.attr("role", l.type),
                    function(d, l, s, m) {
                        function u(e, t, n) {
                            s[e] && d.$watch(s[e], function(e) {
                                n[e] && l.attr(t, n[e])
                            })
                        }
                        ...
                        function p(e) {
                            l[0].hasAttribute("disabled") || d.$apply(function() {
                        ...
                        function f() {
                            m.$viewValue ? l.addClass(c) : l.removeClass(c)
                        }
                        m = m || i.fakeNgModel(), r(l), s.ngChecked && d.$watch(d.$eval.bind(d, s.ngChecked), m.$setViewValue.bind(m)), u("ngDisabled", "tabindex", {
                            "true": "-1",
                            "false": s.tabindex
                        }), n.expectWithText(l, "aria-label"), e.link.pre(d, {
                            on: t.noop,
                            0: {}
                        }, s, [m]), d.mouseActive = !1, l.on("click", p).on("keypress", h).on("mousedown", function() {
                            d.mouseActive = !0, a(function() {
                                d.mouseActive = !1
                            }, 100)
                        }).on("focus", function() {
                            d.mouseActive === !1 && l.addClass("md-focused")
                        }).on("blur", function() {
    ...
    function() {
        ! function() {
            ...
            function n(e, t, n, o, r, i, a, c, l, s, m) {
                if (a(e), this.items = {
                        length: 2e3
            ...
            n.$inject = ["$element", "$attrs", "$scope", "$animate", "$q", "$mdConstant", "$mdTheming", "$$mdDateUtil", "$mdDateLocale", "$mdInkRipple", "$mdUtil"], n.prototype.configureNgModel = function(e) {
                ...
                for (var e = document.createElement("tr"), t = 0; 7 > t; t++) {
                    var n = document.createElement("th");
                    n.textContent = this.dateLocale.shortDays[t], e.appendChild(n)
                }
    ...
    function() {
        ! function() {
            ...
            n.$inject = ["$element", "$$mdDateUtil", "$mdDateLocale"], n.prototype.generateContent = function() {
                ...
                if (s.classList.add("md-calendar-month-label"), this.calendarCtrl.maxDate && n > this.calendarCtrl.maxDate && s.classList.add("md-calendar-month-label-disabled"), s.textContent = this.dateLocale.monthHeaderFormatter(t), 2 >= o) {
                    s.setAttribute("colspan", "7");
                    var m = this.buildDateRow();
                    if (m.appendChild(s), i.insertBefore(m, d), c) return i
                } else l = 2, s.setAttribute("colspan", "2"), d.appendChild(s);
                for (var u = l; o > u; u++) d.appendChild(this.buildDateCell());
    ...
    function() {
        ! function() {
            t.module("material.components.datepicker").config(["$provide", function(e) {
                function t() {
                    this.months = null, this.shortMonths = null, this.days = null, this.shortDays = null, this.dates = null, this.formatDate = null, this.parseDate = null, this.monthHeaderFormatter = null, this.weekNumberFormatter = null, this.longDateFormatter = null, this.msgCalendar = "", this.msgOpenCalendar = ""
                }
                t.prototype.$get = function(e) {
                    ...
                    var s = "Calendar",
                        ...
                        u = {
                            ...
                            msgCalendar: this.msgCalendar || s,
    ...
    function() {
        ! function() {
            ...
            function n(e, n, o, r, i, a, d, c, l, s, m) {
            ...
            t.module("material.components.datepicker").directive("mdDatepicker", e);
            var o = 3,
                r = "md-datepicker-invalid",
                i = 500;
            n.$inject = ["$scope", "$element", "$attrs", "$compile", "$timeout", "$mdConstant", "$mdTheming", "$mdUtil", "$mdDateLocale", "$$mdDateUtil", "$$rAF"], n.prototype.configureNgModel = function(e) {
                this.ngModelCtrl = e;
                var t = this;
                e.$render = function() {
                    t.date = t.ngModelCtrl.$viewValue, t.inputElement.value = t.dateLocale.formatDate(t.date), t.resizeInputElement()
                }
            }, n.prototype.attachChangeListeners = function() {
                var e = this;
                e.$scope.$on("md-calendar-change", function(t, n) {
                    e.ngModelCtrl.$setViewValue(n), e.date = n, e.inputElement.value = e.dateLocale.formatDate(n), e.closeCalendarPane(), e.resizeInputElement(), e.inputContainer.classList.remove(r)
                }), e.ngInputElement.on("input", t.bind(e, e.resizeInputElement)), e.ngInputElement.on("input", e.$mdUtil.debounce(e.handleInputEvent, i, e))
                ...
                var e = this;
                this.$attrs.ngDisabled && this.$element.scope().$watch(this.$attrs.ngDisabled, function(t) {
                    e.setDisabled(t)
                ...
                this.inputElement.size = this.inputElement.value.length + o
            }, n.prototype.handleInputEvent = function() {
                var e = this.inputElement.value,
                    t = this.dateLocale.parseDate(e);
                this.dateUtil.setDateTimeToMidnight(t), this.dateUtil.isValidDate(t) && this.dateLocale.isDateComplete(e) && this.dateUtil.isDateWithinRange(t, this.minDate, this.maxDate) ? (this.ngModelCtrl.$setViewValue(t), this.date = t, this.inputContainer.classList.remove(r)) : this.inputContainer.classList.toggle(r, e)
                ...
                e.style.left = t.left - n.left + "px", e.style.top = t.top - n.top + "px", document.body.appendChild(this.calendarPane), this.inputMask.style.left = t.width + "px", this.$$rAF(function() {
                    e.classList.add("md-pane-open")
                })
            }, n.prototype.detachCalendarPane = function() {
                this.$element.removeClass("md-datepicker-open"), this.calendarPane.classList.remove("md-pane-open"), this.calendarPane.parentNode && this.calendarPane.parentNode.removeChild(this.calendarPane)
            }, n.prototype.openCalendarPane = function(e) {
                if (!this.isCalendarOpen && !this.isDisabled) {
                    this.isCalendarOpen = !0, this.calendarPaneOpenedFrom = e.target, this.attachCalendarPane(), this.focusCalendar(), this.$mdUtil.disableScrollAround(this.calendarPane);
                    var t = this;
                ...
                this.isCalendarOpen = !1, this.detachCalendarPane(), this.calendarPaneOpenedFrom.focus(), this.calendarPaneOpenedFrom = null, this.$mdUtil.enableScrolling(), document.body.removeEventListener("click", this.bodyClickHandler)
            ...
            }, n.prototype.setFocused = function(e) {
                this.isFocused = e
            ...
            t.module("material.components.datepicker").factory("$$mdDateUtil", function() {
                ...
                function u(e, t) {
                    var o = new Date(e.getFullYear(), e.getMonth() + t, 1),
                        r = n(o);
                    return o.setDate(r < e.getDate() ? r : e.getDate()), o
                }
        ...
        function e(e, n) {
            return {
                ...
                link: function(o, r, i) {
                    n(r), e(function() {
                        function e() {
                            r.toggleClass("md-content-overflow", o.scrollHeight > o.clientHeight)
                        }
                        var n, o = r[0].querySelector("md-dialog-content");
                        o && (n = o.getElementsByTagName("img"), e(), t.element(n).on("load", e))
                    })
                }
            }
        }
        ...
        function n(e) {
            ...
            function o(e, n, o, r, i, a, d, c) {
                    ...
                    function c() {
                        if (i) {
                            var e = /<\/[\w-]*>/gm,
                                t = i.content || "",
                                n = e.test(t);
                            n || (t = o.supplant("<p>{0}</p>", [t])), i.content = t
                        }
                    }
                    return n = o.extractElementByName(n, "md-dialog"), t.element(a[0].body).addClass("md-dialog-is-showing"), c(), m(n, r), p(n.find("md-dialog"), r), h(e, n, r), b(n, r).then(function() {
                        u(n, r), f(n, r), d()
                    })
                }

                function s(e, n, o) {
                    return o.deactivateListeners(), o.unlockScreenReader(), o.hideBackdrop(), E(n, o)["finally"](function() {
                        t.element(a[0].body).removeClass("md-dialog-is-showing"), n.remove(), o.origin.focus()
                    })
                }
                ...
                function m(e, n) {
                    ...
                    n.origin = t.extend({}, o, n.origin || {});
                    var r = t.element((n.targetEvent || {}).target);
                    r && r.length && (n.origin.element = r, n.origin.bounds = r[0].getBoundingClientRect(), n.origin.focus = function() {
                        r.focus()
                ...
                function u(t, n) {
                    var i = [],
                        a = function() {
                            var t = "alert" == n.$type ? e.hide : e.cancel;
                            o.nextTick(t, !0)
                        };
                    if (n.escapeToClose) {
                        var d = n.parent,
                            c = function(e) {
                                e.keyCode === r.KEY_CODE.ESCAPE && (e.stopPropagation(), e.preventDefault(), a())
                            };
                        t.on("keyup", c), d.on("keyup", c), i.push(function() {
                            t.off("keyup", c), d.off("keyup", c)
                        })
                    }
                    if (n.clickOutsideToClose) {
                        var d = t,
                            l = function(e) {
                                e.target === d[0] && (e.stopPropagation(), e.preventDefault(), a())
                            };
                        d.on("click", l), i.push(function() {
                            d.off("click", l)
                        })
                    }
                    n.deactivateListeners = function() {
                        i.forEach(function(e) {
                            e()
                        }), n.deactivateListeners = null
                    }
                }

                function h(e, t, n) {
                    n.disableParentScroll && (n.restoreScroll = o.disableScrollAround(t, n.parent)), n.hasBackdrop && (n.backdrop = o.createBackdrop(e, "md-dialog-backdrop md-opaque"), i.enter(n.backdrop, n.parent)), n.hideBackdrop = function() {
                        n.backdrop && i.leave(n.backdrop), n.disableParentScroll && (n.restoreScroll(), delete n.restoreScroll), n.hideBackdrop = null
                    }
                }
                ...
                function g(e, t) {
                    var n = "fixed" == d.getComputedStyle(a[0].body).position,
                        ...
                        i = r ? Math.ceil(Math.abs(parseInt(r.height, 10))) : 0;
                    return e.css({
                        top: (n ? o.scrollTop(t.parent) / 2 : 0) + "px",
                        height: i ? i + "px" : "100%"
                    }), e
                }
    ...
    function() {
        ! function() {
            function n(n, o, r, i, a) {
                function d() {
                    H.direction = H.direction || "down", H.isOpen = H.isOpen || !1, p()
                }
                ...
                function u(e) {
                    return I.push(e.type), s(["mousedown", "focusout?", "focusin?", "mouseup", "click"]) ? (N(e), void l()) : s(["touchstart?", "touchend?", "click"]) ? (N(e), void l()) : s(["focusin"]) ? (H.open(), void l()) : s(["focusout"]) ? (H.close(), void l()) : void h()
                }
                ...
                function v(e) {
                    switch (e.which) {
                        ...
                        case a.KEY_CODE.ESCAPE:
                            return H.close(), e.preventDefault(), !1;
                ...
                function y(e, n) {
                    var o = S()[0].querySelectorAll(".md-fab-action-item");
                    t.forEach(o, function(e) {
                        t.element(t.element(e).children()[0]).attr("tabindex", -1)
                    }), H.currentActionIndex = H.currentActionIndex + n, H.currentActionIndex = Math.min(o.length - 1, H.currentActionIndex), H.currentActionIndex = Math.max(0, H.currentActionIndex);
                    var r = t.element(o[H.currentActionIndex]).children()[0];
                    t.element(r).attr("tabindex", 0), r.focus(), e.preventDefault(), e.stopImmediatePropagation()
                }

                function C(e) {
                    "left" === H.direction ? $(e) : M(e)
                }

                function A(e) {
                    "down" === H.direction ? M(e) : $(e)
                }

                function T(e) {
                    "left" === H.direction ? M(e) : $(e)
                }

                function k(e) {
                    "up" === H.direction ? M(e) : $(e)
                }
                ...
                function N(e) {
                    w(e.target) && H.toggle(), x(e.target) && H.close()
                }
                ...
                function n(n, o, r) {
                    if (o) {
                        var i = n[0],
                            ...
                            l = i.querySelector("md-toolbar"),
                            s = i.querySelector("md-fab-trigger button md-icon"),
                            m = n.find("md-fab-actions").children();
                        if (c && d) {
                            var u = e.getComputedStyle(c).getPropertyValue("background-color"),
                                h = i.offsetWidth,
                                p = (i.offsetHeight, 2 * h);
                            d.style.backgroundColor = u, d.style.borderRadius = h + "px", a.isOpen ? (l.style.pointerEvents = "initial", d.style.width = p + "px", d.style.height = p + "px", d.style.top = -(p / 2) + "px", n.hasClass("md-right") && (d.style.left = -(p / 2) + "px", d.style.right = null), n.hasClass("md-left") && (d.style.right = -(p / 2) + "px", d.style.left = null), d.style.transitionDelay = "0ms", s && (s.style.transitionDelay = ".3s"), t.forEach(m, function(e, t) {
                                e.style.transitionDelay = 25 * (m.length - t) + "ms"
                            })) : (l.style.pointerEvents = "none", d.style.width = c.offsetWidth + "px", d.style.height = c.offsetHeight + "px", d.style.top = "0px", n.hasClass("md-right") && (d.style.left = "0px", d.style.right = null), n.hasClass("md-left") && (d.style.right = "0px", d.style.left = null), d.style.transitionDelay = "200ms", s && (s.style.transitionDelay = "0ms"), t.forEach(m, function(e, t) {
        ...
        function o(e) {
            ...
            function r(e, t) {
                function n(t, n) {
                    ...
                    for (var a = 0, s = 0; s - a < t.col;) d >= e ? o() : (a = l.indexOf(0, d), -1 !== a && -1 !== (s = i(a + 1)) ? d = s + 1 : (a = s = 0, o()));
    ...
    function() {
        ...
        function o(e, n, o) {
            function r(r, i, a, d) {
                ...
                function s() {
                    ...
                    function a() {
                        if (s.style.height = s.offsetHeight + "px", i.addClass("md-no-flex"), isNaN(u)) {
                            l.style.height = "auto", l.scrollTop = 0;
                            var e = d();
                            e && (l.style.height = e + "px")
                        } else {
                            l.setAttribute("rows", 1), p || (l.style.minHeight = "0", p = i.prop("clientHeight"), l.style.minHeight = null);
                            var t = Math.max(u, Math.round(l.scrollHeight / p));
                            l.setAttribute("rows", t)
                        }
                        i.removeClass("md-no-flex"), s.style.height = "auto"
                    }
                    ...
                    if (!t.isDefined(i.attr("md-no-autogrow"))) {
                        var l = i[0],
                            ...
                            u = 0 / 0,
                            p = null;
                        l.hasAttribute("rows") && (u = parseInt(l.getAttribute("rows")));
                ...
                if (m) {
                    ...
                    m.input = i, m.label || o.expect(i, "aria-label", i.attr("placeholder")), i.addClass("md-input"), i.attr("id") || i.attr("id", "input_" + e.nextUid()), "textarea" === i[0].tagName.toLowerCase() && s(), u || l();
                    var f = m.isErrorGetter || function() {
                        return h.$invalid && h.$touched
                    };
                    r.$watch(f, m.setInvalid), h.$parsers.push(c), h.$formatters.push(c), i.on("input", l), p || i.on("focus", function(e) {
                        m.setFocused(!0)
                    }).on("blur", function(e) {
                        m.setFocused(!1), l()
        ...
        function r(e) {
            function n(n, o, r, i) {
                function a(e) {
                    return s.text((o.val() || e || "").length + "/" + d), e
                }
                var d, c = i[0],
                    l = i[1],
                    s = t.element('<div class="md-char-counter">');
                r.$set("ngTrim", "false"), l.element.append(s), c.$formatters.push(a), c.$viewChangeListeners.push(a), o.on("input keydown", function() {
                    a()
                }), n.$watch(r.mdMaxlength, function(n) {
                    d = n, t.isNumber(n) && n > 0 ? (s.parent().length || e.enter(s, l.element, t.element(l.element[0].lastElementChild)), a()) : e.leave(s)
        ...
        function i(e) {
            function n(n, o, r, i) {
                if (i && !t.isDefined(i.element.attr("md-no-float"))) {
                    var a = r.placeholder;
                    if (o.removeAttr("placeholder"), 0 == i.element.find("label").length) {
                        if (i.input && "MD-SELECT" != i.input[0].nodeName) {
                            var d = '<label ng-click="delegateClick()">' + a + "</label>";
                            i.element.addClass("md-icon-float"), i.element.prepend(d)
                        }
                    } else "MD-SELECT" != o[0].nodeName && e.warn("The placeholder='" + a + "' will be ignored since this md-input-container has a child label element.")
                }
            }
            return {
                restrict: "A",
        ...
        function n(e, n, o) {
            ...
            return {
                ...
                compile: function(i, a) {
                    ...
                    function c(n) {
                        var o;
                        if ("div" == n) o = t.element('<div class="md-no-style md-list-item-inner">'), o.append(i.contents()), i.addClass("md-proxy-focus");
                        else {
                        ...
                        if (i[0].setAttribute("tabindex", "-1"), i.append(o), h && h.hasAttribute("ng-click")) {
                            e.expect(h, "aria-label");
                            var d = t.element('<md-button class="md-secondary-container md-icon-button">');
                            d.attr("ng-click", h.getAttribute("ng-click")), h.removeAttribute("ng-click"), h.setAttribute("tabindex", "-1"), h.classList.remove("md-secondary"), d.append(h), h = d[0]
                        }
                        h && (h.hasAttribute("ng-click") || a.ngClick && l(h)) && (i.addClass("md-with-secondary"), i.append(h))
                    }
                    ...
                    function s(e, i, a, d) {
                        ...
                        function l() {
                            (s.length || u) && (i.addClass("md-clickable"), d.attachRipple(e, t.element(i[0].querySelector(".md-no-style"))))
                        }
                        var s = [],
                            m = i[0].firstElementChild,
                            u = m && m.hasAttribute("ng-click");
                        c(), l(), i.hasClass("md-proxy-focus") && s.length && t.forEach(s, function(n) {
                        ...
                        }), u || s.length || m && m.addEventListener("keypress", function(e) {
                            if ("INPUT" != e.target.nodeName && "TEXTAREA" != e.target.nodeName) {
                                var t = e.which || e.keyCode;
                                t == n.KEY_CODE.SPACE && m && (m.click(), e.preventDefault(), e.stopPropagation())
                            }
                        }), i.off("click"), i.off("keypress"), s.length && m && i.children().eq(0).on("click", function(e) {
                            m.contains(e.target) && t.forEach(s, function(n) {
                                e.target === n || n.contains(e.target) || t.element(n).triggerHandler("click")
                            })
                        })
                    }
                    var m, u, h = i[0].querySelector(".md-secondary");
                    if (i[0].setAttribute("role", "listitem"), a.ngClick) c("button");
                    else {
                        for (var p, f = 0; p = r[f]; ++f)
                            if (u = i[0].querySelector(p)) {
                                m = !0;
                                break
                            }
                        m ? c("div") : i[0].querySelector("md-button") || i.addClass("md-no-proxy")
                    }
                    return d(), s
                }
            }
    ...
    function() {
        function e(e, o, r) {
            ...
            function a(i, a, h) {
                ...
                function b(e) {
                    if (v()) {
                        A = A || t.element(a[0].querySelector(".md-left > .md-half-circle")), T = T || t.element(a[0].querySelector(".md-right > .md-half-circle")), k = k || t.element(a[0].querySelector(".md-gap"));
                        var n = c({
                        ...
                        A.css(C(r)), T.css(C(i)), k.css(C(n))
                    }
                }

                function E() {
                    if (!h.mdDiameter) return s;
                ...
                function s(o) {
                    ...
                    switch (r) {
                        ...
                        case n.KEY_CODE.UP_ARROW:
                            o.preventDefault(), m.selectPrevious(), l();
                            break;
                        case n.KEY_CODE.RIGHT_ARROW:
                        case n.KEY_CODE.DOWN_ARROW:
                            o.preventDefault(), m.selectNext(), l();
                            break;
        ...
        function n(e, t, n) {
            function o(o, i, a, d) {
                ...
                function l() {
                    ...
                    e !== m && (m = e, i.attr("aria-checked", e), e ? (i.addClass(r), d.setActiveDescendant(i.attr("id"))) : i.removeClass(r))
                }
                ...
                var m;
                n(i), s(i, o), d.add(l), a.$observe("value", l), i.on("click", c).on("$destroy", function() {
                    d.remove(l)
                })
            }
            var r = "md-checked";
                ...
                function h() {
                    u.$observe("value", function(e) {
                        ...
                        switch (e) {
                            ...
                            case c:
                            case l:
                                $.removeClass("ng-hide"), $.removeClass(b), $.addClass(b = "md-mode-" + e);
                                break;
                            default:
    ...
    function() {
        function e(e, o, r, i, a, d, c) {
            function l(a, l) {
                ...
                var h = t.isDefined(l.multiple) ? "multiple" : "",
                    p = '<div class="md-select-menu-container"><md-select-menu {0}>{1}</md-select-menu></div>';
                return p = o.supplant(p, [h, a.html()]), a.empty().append(s), l.tabindex = l.tabindex || "0",
                    function(a, l, s, m) {
                        function u() {
                            var e = l.attr("placeholder");
                            !e && $ && $.label && (e = $.label.text()), i.expect(l, "aria-label", e)
                        }
                        ...
                        function f() {
                            $ && $.setHasValue(_.selectedLabels().length > 0 || (l[0].validity || {}).badInput)
                        }

                        function g() {
                            x = t.element(p);
                            var e = x.find("md-select-menu");
                            e.data("$ngModelController", C), e.data("$mdSelectController", y), N = a.$new(), r.inherit(x, l), x[0].setAttribute("class", x[0].getAttribute("class") + " " + l.attr("md-container-class")), x = d(x)(N), _ = x.find("md-select-menu").controller("mdSelectMenu")
                        }
                        ...
                        function b(e) {
                            ...
                            if (-1 != n.indexOf(e.keyCode)) e.preventDefault(), E(e);
                                ...
                                _.isMultiple || _.deselect(Object.keys(_.selected)[0]), _.select(r.hashKey, r.value), _.refreshViewValue(), C.$render()
                            }
                        }

                        function E() {
                            a.$apply("isOpen = true"), e.show({
                                scope: N,
                                preserveScope: !0,
                                skipCompile: !0,
                                element: x,
                        ...
                        var v, M, $ = m[0],
                            ...
                            C = m[2],
                            A = m[3],
                            T = l.find("md-select-value"),
                            k = t.isDefined(s.readonly);
                        if ($) {
                            var w = $.isErrorGetter || function() {
                                return C.$invalid && C.$touched
                            };
                            if ($.input) throw new Error("<md-input-container> can only have *one* child <input>, <textarea> or <select> element!");
                            $.input = l, $.label || i.expect(l, "aria-label", l.attr("placeholder")), a.$watch(w, $.setInvalid)
                        }
                        var x, N, _;
                        if (g(), r(l), s.name && A) {
                            var S = l.parent()[0].querySelector('select[name=".' + s.name + '"]'),
                                H = t.element(S).controller();
                            H && A.$removeControl(H)
                        }
                        var D = C.$render;
                        C.$render = function() {
                            D(), h(), f()
                        }, y.setLabelText = function(e) {
                            ...
                            e ? (T.addClass("md-select-placeholder"), $ && $.label && $.label.addClass("md-placeholder md-static")) : (T.removeClass("md-select-placeholder"), $ && $.label && $.label.removeClass("md-placeholder"))
                        }, k || l.on("focus", function(e) {
                        ...
                        s.$observe("ngMultiple", function(e) {
                            ...
                            I = a.$watch(function() {
                                ...
                                (e !== n || t !== n) && (e ? l.attr("multiple", "multiple") : l.removeAttr("multiple"), x && (_.setMultiple(e), D = C.$render, C.$render = function() {
                                    D(), h()
                                }, _.refreshViewValue(), C.$render()))
                            })
                        }), s.$observe("disabled", function(e) {
                            "string" == typeof e && (e = !0), (M === n || M !== e) && (M = e, e ? (l.attr({
                                tabindex: -1,
                                "aria-disabled": "true"
                            }), l.off("click", E), l.off("keydown", b)) : (l.attr({
                                tabindex: s.tabindex,
                                "aria-disabled": "false"
                            }), l.on("click", E), l.on("keydown", b)))
                        }), s.disabled || s.ngDisabled || (l.attr({
                            tabindex: s.tabindex,
                            "aria-disabled": "false"
                        }), l.on("click", E), l.on("keydown", b));
                        var O = {
                        ...
                        l[0].hasAttribute("id") || (O.id = "select_" + o.nextUid()), l.attr(O), a.$on("$destroy", function() {
                            v ? e.hide()["finally"](function() {
                                x.remove()
                            }) : x.remove(), $ && ($.setFocused(!1), $.setHasValue(!1), $.input = null)
                        })
                    }
            }
            return {
        ...
        function o(e, o, r) {
            function i(e, n, i, a) {
                ...
                var s = a[0],
                    m = a[1];
                r(n), n.on("click", l), n.on("keypress", c), m && s.init(m), d()
            }
            ...
            function a(r, i, a) {
                function d() {
                    ...
                    if (t.isArray(e)) {
                        var n = Object.keys(s.selected),
                            o = e.map(s.hashGetter),
                            r = n.filter(function(e) {
                                return -1 === o.indexOf(e)
                            });
                        r.forEach(s.deselect), o.forEach(function(t, n) {
                            s.select(t, e[n])
                        })
                    }
                }
                ...
                var s = this;
                s.isMultiple = t.isDefined(i.multiple), s.selected = {}, s.options = {}, r.$watch(function() {
                    return s.options
                }, function() {
                    s.ngModel.$render()
                }, !0);
                ...
                s.setMultiple = function(e) {
                    ...
                    var o = s.ngModel;
                    s.isMultiple = e, m && m(), s.isMultiple ? (o.$validators["md-multiple"] = n, o.$render = d, r.$watchCollection(i.ngModel, function(e) {
                        n(e) && d(e)
                ...
                s.optNodeForKeyboardSearch = function(e) {
                    ...
                    if (s.ngModel = n, n.$options && n.$options.trackBy) {
                        var o = {},
                ...
                }, s.addOption = function(e, n) {
                    if (t.isDefined(s.options[e])) throw new Error('Duplicate md-option values are not allowed in a select. Duplicate value "' + n.value + '" found.');
                    s.options[e] = n, t.isDefined(s.selected[e]) && (s.select(e, n.value), s.refreshViewValue())
        ...
        function r(e, n) {
            ...
            function r(o, r, i, a) {
                function d(e, t) {
                    var n = s.hashGetter(t, o),
                        r = s.hashGetter(e, o);
                    l.hashKey = r, l.value = e, s.removeOption(n, l), s.addOption(r, l)
                }
                ...
                var l = a[0],
                    s = a[1];
                t.isDefined(i.ngValue) ? o.$watch(i.ngValue, d) : t.isDefined(i.value) ? d(isNaN(i.value) ? i.value : Number(i.value)) : o.$watch(function() {
                    return r.text()
                }, d), i.$observe("disabled", function(e) {
                    e ? r.attr("tabindex", "-1") : r.attr("tabindex", "0")
                }), o.$$postDigest(function() {
                    i.$observe("selected", function(e) {
                        t.isDefined(e) && ("string" == typeof e && (e = !0), e ? (s.isMultiple || s.deselect(Object.keys(s.selected)[0]), s.select(l.hashKey, l.value)) : s.deselect(l.hashKey), s.refreshViewValue(), s.ngModel.$render())
                    })
                }), e.attach(o, r), c(), o.$on("$destroy", function() {
                    s.removeOption(l.hashKey, l)
                })
            }
        ...
        function a(e) {
            function o(e, o, c, l, s, m, u, h) {
                function p(e, t, n) {
                    return n.cleanupInteraction(), n.cleanupResizing(), n.hideBackdrop(), u(t, {
                        addClass: "md-leave"
                    }).start().then(function(e) {
                        return g(n.target, !1), t.removeClass("md-active"), b(n), E(t, n), e
                    })["finally"](function() {
                        n.restoreFocus && n.target.focus()
                    })
                }

                function f(r, i, a) {
                    function d(e, t, n) {
                        return n.parent.append(t), s(function(e, n) {
                            try {
                                u(t, {
                    ...
                    function p() {
                        return s(function(e) {
                            if (a.isRemoved) return s.reject(!1);
                            var t = v(r, i, a);
                    ...
                    function f(e, t, n) {
                        return n.disableParentScroll && !c.getClosest(n.target, "MD-DIALOG") ? n.restoreScroll = c.disableScrollAround(n.element, n.parent) : n.disableParentScroll = !1, n.hasBackdrop && (n.backdrop = c.createBackdrop(e, "md-select-backdrop md-click-catcher"), h.enter(n.backdrop, n.parent, null, {
                            ...
                            function() {
                                n.backdrop && h.leave(n.backdrop, {
                                    duration: 0
                                }), n.disableParentScroll && (n.restoreScroll(), delete n.restoreScroll)
                            }
                    }
                    ...
                    function C() {
                        a.loadingAsync && !a.isRemoved && (r.$$loadingAsyncDone = !1, r.progressMode = "indeterminate", s.when(a.loadingAsync).then(function() {
                            ...
                            function n() {
                                ...
                                if (t && t.currentTarget.children.length > 0) {
                                    ...
                                    if (o && n.children.length > 0) {
                                        ...
                                        r > n.children[0].offsetWidth && (e = !0)
                                    }
                                }
                                return e
                            }
                    ...
                    return C(), E(r, a), g(a.target), a.hideBackdrop = f(r, i, a), d(r, i, a).then(function(e) {
                        return a.alreadyOpen = !0, a.cleanupInteraction = A(), a.cleanupResizing = y(), e
                    }, a.hideBackdrop)
                }
                ...
                function v(e, n, o) {
                    var s, m, u = n[0],
                        ...
                        s = f.getElementsByTagName("md-option"),
                        T = f.getElementsByTagName("md-optgroup"),
                        k = r(o.loadingAsync);
                    m = k ? g.firstElementChild || g : A ? A : T.length ? T[0] : s.length ? s[0] : g.firstElementChild || g, g.offsetWidth > y && (g.style["max-width"] = y + "px"), v && (g.style["min-width"] = E.width + "px"), C && f.classList.add("md-overflow");
                    var w = m;
                    "MD-OPTGROUP" === (w.tagName || "").toUpperCase() && (w = s[0] || g.firstElementChild || g, m = w), o.focusedNode = w;
                    var x = f.getBoundingClientRect(),
                        N = a(m);
                    if (m) {
                        var _ = l.getComputedStyle(m);
                        N.paddingLeft = parseInt(_.paddingLeft, 10) || 0, N.paddingRight = parseInt(_.paddingRight, 10) || 0
                    }
                    if (C) {
                        var S = g.offsetHeight / 2;
                        g.scrollTop = N.top + N.height / 2 - S, $.top < S ? g.scrollTop = Math.min(N.top, g.scrollTop + S - $.top) : $.bottom < S && (g.scrollTop = Math.max(N.top + N.height - x.height, g.scrollTop - S + $.bottom))
                    }
                    var H, D, I, O;
                    v ? (H = E.left, D = E.top + E.height, I = "50% 0", D + x.height > M.bottom && (D = E.top - x.height, I = "50% 100%")) : (H = E.left + N.left - N.paddingLeft + 2, D = Math.floor(E.top + E.height / 2 - N.height / 2 - N.top + g.scrollTop) + 2, I = N.left + E.width / 2 + "px " + (N.top + N.height / 2 - g.scrollTop) + "px 0px", O = E.width + N.paddingLeft + N.paddingRight);
                    ...
                    return {
                        container: {
                            element: t.element(u),
                            styles: {
                                left: Math.floor(i(M.left, H, M.right - R.width)),
    ...
    function() {
        function e(e, n, o, r, i, a, d, c, l) {
            ...
            function m(o, s, m, u) {
                ...
                function p(e) {
                    G = parseFloat(e), s.attr("aria-valuemin", e), h()
                }

                function f(e) {
                    X = parseFloat(e), s.attr("aria-valuemax", e), h()
                }
                ...
                function E() {
                    if (t.isDefined(m.mdDiscrete) && !t.isUndefined(Q)) {
                        ...
                        if (!Z) {
                            Z = t.element('<canvas style="position:absolute;">'), V.append(Z);
                ...
                function C() {
                    ...
                    o.modelValue = u.$viewValue, s.attr("aria-valuenow", u.$viewValue), k(e), U.text(u.$viewValue)
                }
                ...
                function T(e) {
                    if (t.isNumber(e)) {
                        var n = Math.round(e / Q) * Q;
                        return Math.round(1e3 * n) / 1e3
                    }
                }

                function k(e) {
                    j.css("width", 100 * e + "%"), q.css("left", 100 * e + "%"), s.toggleClass("md-min", 0 === e)
                }

                function w(e) {
                    if (!F()) {
                        s.addClass("active"), s[0].focus(), v();
                        var t = R(O(e.pointer.x)),
                            n = A(T(t));
                        o.$apply(function() {
                            y(n), k(L(n))
                        })
                ...
                function N(e) {
                    F() || (te = !0, e.stopPropagation(), s.addClass("dragging"), H(e))
                }

                function _(e) {
                    te && (e.stopPropagation(), H(e))
                }
                ...
                var P = m.ngDisabled && c(m.ngDisabled),
                    F = P ? function() {
                        return P(o.$parent)
                    } : t.noop,
                    B = t.element(s[0].querySelector(".md-thumb")),
                    U = t.element(s[0].querySelector(".md-thumb-text")),
                    q = B.parent(),
                    z = t.element(s[0].querySelector(".md-track-container")),
                    j = t.element(s[0].querySelector(".md-track-fill")),
                    V = t.element(s[0].querySelector(".md-track-ticks")),
                    W = r.throttle(v, 5e3);
                t.isDefined(m.min) ? m.$observe("min", p) : p(0), t.isDefined(m.max) ? m.$observe("max", f) : f(100), t.isDefined(m.step) ? m.$observe("step", g) : g(1);
                var Y = t.noop;
                m.ngDisabled && (Y = o.$parent.$watch(m.ngDisabled, b)), d.register(s, "drag"), s.on("keydown", $).on("$md.pressdown", w).on("$md.pressup", x).on("$md.dragstart", N).on("$md.drag", _).on("$md.dragend", S), setTimeout(h);
                var K = e.throttle(h);
    ...
    function() {
        ...
        function r(e, o, r, i, a, d, c, l, s, m) {
            function u(d, u, h, p) {
                function f(e, t) {
                ...
                function g(e) {
                    var t = o.findFocusTarget(u) || o.findFocusTarget(u, "[md-sidenav-focus]") || u,
                        n = u.parent();
                    return n[e ? "on" : "off"]("keydown", v), k[e ? "on" : "off"]("click", M), e && (y = m[0].activeElement), b(e), C = s.all([e ? a.enter(k, n) : a.leave(k), a[e ? "removeClass" : "addClass"](u, "md-closed")]).then(function() {
                        d.isOpen && t && t.focus()
                    })
                }
                ...
                function E(e) {
                    return d.isOpen == e ? s.when(!0) : s(function(t) {
                ...
                u.on("$destroy", p.destroy), i.inherit(k, u), d.$watch(T, f), d.$watch("isOpen", g), p.$toggleOpen = E
            }
            return {
                restrict: "E",
                scope: {
        ...
        function e(e, o, r, i) {
            function a(e) {
                ...
                function l() {
                    ...
                    if (l.prevScrollTop = e, 0 === e) return void s(null);
                    if (t) {
                        if (f.next && f.next.top <= e) return void s(f.next);
                        if (f.current && f.next && f.next.top - e <= f.next.height) return void u(f.current, e + (f.next.top - f.next.height - e))
                    }
                    if (!t) {
                        if (f.current && f.prev && e < f.current.top) return void s(f.prev);
                ...
                var h = e.$element,
                    p = r.throttle(a);
                c(h), h.on("$scrollstart", p), h.on("$scroll", l);
                var f;
                return f = {
                    prev: null,
                    current: null,
        ...
        function e(e, n, o, r) {
            return {
                ...
                link: function(i, a, d, c, l) {
                    ...
                    l(i, function(e) {
                        s(a).append(e)
                    }), a.hasClass("md-no-sticky") || l(i, function(t) {
        ...
        function e(e, n, o, r, i, a, d, c) {
            function l(e, n) {
                ...
                return e.addClass("md-dragging"),
                    function(e, n, l, s) {
                        function m(t) {
                            f(e) || (t.stopPropagation(), n.addClass("md-dragging"), E = {
                        ...
                        function u(e) {
                            if (E) {
                                ...
                                var t = e.pointer.distanceX / E.width,
                                    n = s.$viewValue ? 1 + t : t;
                                n = Math.max(0, Math.min(1, n)), g.css(i.CSS.TRANSFORM, "translate3d(" + 100 * n + "%,0,0)"), E.translate = n
                            }
                        }

                        function h(e) {
                            if (E) {
                                e.stopPropagation(), n.removeClass("md-dragging"), g.css(i.CSS.TRANSFORM, "");
                                var t = s.$viewValue ? E.translate < .5 : E.translate > .5;
                                t && p(!s.$viewValue), E = null
                            }
                        }
                        ...
                        s = s || o.fakeNgModel();
                        var f = a(l.ngDisabled),
                            g = t.element(n[0].querySelector(".md-thumb-container")),
                            b = t.element(n[0].querySelector(".md-container"));
                        d(function() {
                            n.removeClass("md-dragging")
                        }), r(e, n, l, s), t.isDefined(l.ngDisabled) && e.$watch(f, function(e) {
                            n.attr("tabindex", e ? -1 : 0)
                        }), c.register(b, "drag"), b.on("$md.dragstart", m).on("$md.drag", u).on("$md.dragend", h);
                        var E
                    }
            }
            var s = e[0];
    ...
    function() {
        ...
        function n(e) {
            function t(e, t, o) {
                function r(r, i, c) {
                    return n = c.content, i = o.extractElementByName(i, "md-toast"), c.onSwipe = function(e, n) {
                ...
                function i(t, n, o) {
                    return n.off(d, o.onSwipe), o.parent.removeClass(o.openClass), e.leave(n)
                }
                ...
                link: function(d, c, l) {
                    function s() {
                        function r(e) {
                            ...
                            !f && t.length && s(null, t), e = d.$eval(e), e === !1 ? g() : g = u()
                        }
                        ...
                        var p, f, g = t.noop,
                            b = 0,
                            E = 0,
                            v = l.mdShrinkSpeedFactor || .5,
                            M = e.throttle(m),
                            $ = o.debounce(h, 5e3);
                        d.$on("$mdContentLoaded", s), l.$observe("mdScrollShrink", r), d.$on("$destroy", g)
                    }
                    r(c), t.isDefined(l.mdScrollShrink) && s()
                }
            }
        }
    ...
    function() {
        function e(e, n, o, r, i, a, d, c, l) {
            function s(s, h, p) {
                function f() {
                    t.isDefined(p.mdDelay) || (s.delay = m)
                }

                function g() {
                    s.$on("$destroy", function() {
                        s.visible = !1, h.remove(), t.element(n).off("resize", D)
                ...
                function v() {
                    for (var e = h.parent(); e && $("pointer-events", "none", e[0]);) e = e.parent();
                    return e
                }
                ...
                function $(e, o, r) {
                    e = p.$normalize(e), r = r || h[0];
                    var i = n.getComputedStyle(r);
                    return t.isDefined(i[e]) && i[e] == o
                }
                ...
                function y() {
                    var e = !1,
                        ...
                        a = !1;
                    o.on("blur", i), s.$on("$destroy", function() {
                        o.off("blur", i)
                    });
                    var d = function(e) {
                            return "focus" === e.type && a ? void(a = !1) : (w.on("blur mouseleave touchend touchcancel", c), void C(!0))
                        },
                        c = function() {
                            var t = s.hasOwnProperty("autohide") ? s.autohide : p.hasOwnProperty("mdAutohide");
                            (t || e || r[0].activeElement !== w[0]) && (w.off("blur mouseleave touchend touchcancel", c), C(!1)), e = !1
                        };
                ...
                function C(t) {
                    C.value = !!t, C.queued || (t ? (C.queued = !0, e(function() {
                        s.visible = C.value, C.queued = !1
                    }, s.delay)) : i.nextTick(function() {
                        s.visible = !1
                    }))
                }

                function A() {
                    return H.append(h), $("display", "none") ? (s.visible = !1, void h.detach()) : (k(), void t.forEach([h, x, N], function(e) {
                ...
                function k() {
                    ...
                    function t(e) {
                        ...
                        return t.left = Math.min(t.left, H.prop("scrollWidth") - o.width - u), t.left = Math.max(t.left, u), t.top = Math.min(t.top, H.prop("scrollHeight") - o.height - u), t.top = Math.max(t.top, u), t
                    }
    ...
    function() {
        ...
        o.$inject = ["$$rAF", "$scope", "$element", "$attrs"], o.prototype.register = function(e) {
            ...
            for (var s = a - 1; a < this.newEndIndex; a++) d = this.getBlock_(a), this.updateBlock_(d, a), l.push(d);
            c.length && this.parentNode.insertBefore(this.domFragmentFromBlocks_(c), this.$element[0].nextSibling), l.length && this.parentNode.insertBefore(this.domFragmentFromBlocks_(l), this.blocks[s] && this.blocks[s].element[0].nextSibling), this.$browser.$$checkUrlChange = this.browserCheckUrlChange, this.startIndex = this.newStartIndex, this.endIndex = this.newEndIndex
    ...
    function() {
        function e(e, o, a, d, c, l, s, m, u, h) {
            function p() {
            ...
            function f() {
                function e() {
                    var e = re.scrollContainer.getBoundingClientRect(),
                        n = {};
                    e.right > o.right - i && (n.left = t.right - e.width + "px"), re.$.scrollContainer.css(n)
                }
                if (!re) return a.nextTick(f, !1);
                var t = re.wrap.getBoundingClientRect(),
                    n = re.snap.getBoundingClientRect(),
                    o = re.root.getBoundingClientRect(),
                    d = n.bottom - o.top,
                    c = o.bottom - n.top,
                    l = t.left - o.left,
                    s = t.width,
                    m = {
                        left: l + "px",
                        minWidth: s + "px",
                        maxWidth: Math.max(t.right - o.left, o.right - t.left) - i + "px"
                    };
                d > c && o.height - t.bottom - i < r ? (m.top = "auto", m.bottom = c + "px", m.maxHeight = Math.min(r, t.top - o.top - i) + "px") : (m.top = d + "px", m.bottom = "auto", m.maxHeight = Math.min(r, o.bottom - t.bottom - i) + "px"), re.$.scrollContainer.css(m), a.nextTick(e, !1)
            }

            function g() {
                re.$.root.length && (c(re.$.scrollContainer), re.$.scrollContainer.detach(), re.$.root.append(re.$.scrollContainer), s.pin && s.pin(re.$.scrollContainer, m))
            }
            ...
            function E() {
                ...
                }), e.$watch("searchText", n ? a.debounce(D, n) : D), e.$watch("selectedItem", w), t.element(l).on("resize", f), e.$on("$destroy", v)
            }

            function v() {
                t.element(l).off("resize", f), re.$.scrollContainer.remove()
            }
            ...
            function C(e, t) {
                !e && t ? (f(), re && a.nextTick(function() {
                    a.disableScrollAround(re.ul)
                }, !1)) : e && !t && a.nextTick(function() {
                    a.enableScrolling()
                }, !1)
            }
            ...
            function O() {
                ce = !0, t.isString(e.searchText) || (e.searchText = ""),
                    e.minLength > 0 || (te.hidden = U(), te.hidden || J())
            }
            ...
            function G() {
                if (le === te.matches.length) return "";
                switch (le = te.matches.length, te.matches.length) {
                    case 0:
            ...
            var te = this,
                ...
                ce = !1,
                le = 0;
            return j("hidden", C, !0), te.scope = e, te.parent = e.$parent, te.itemName = ne[0], te.matches = [], te.loading = !1, te.hidden = !0, te.index = null, te.messages = [], te.id = a.nextUid(), te.isDisabled = null, te.isRequired = null, te.keydown = R, te.blur = I, te.focus = O, te.clear = W, te.select = V, te.listEnter = A, te.listLeave = T, te.mouseUp = k, te.getCurrentDisplayValue = q, te.registerSelectedItemWatcher = S, te.unregisterSelectedItemWatcher = H, te.notFoundVisible = Z, p()
        }
            ...
            function r(r, i) {
                var d = null,
                    ...
                    s = e.$watch(function(e) {
                        ...
                        (null === d || e.unsafeText !== o.unsafeText) && (d = t.element("<div>").text(e.unsafeText).html()), (null === c || e.term !== o.term) && (c = a(e.term, l)), n.html(d.replace(c, '<span class="highlight">$&</span>'))
                    }, !0);
                n.on("$destroy", function() {
                    s()
                })
    ...
    function() {
        ...
        t.module("material.components.autocomplete").directive("mdAutocompleteParentScope", e), e.$inject = ["$compile"]
    }(),
    function() {
        function e(e, o) {
            function r(n, r) {
    ...
    function() {
        ...
        t.module("material.components.chips").controller("MdChipsCtrl", e), e.$inject = ["$scope", "$mdConstant", "$log", "$element", "$timeout"], e.prototype.inputKeydown = function(e) {
            ...
            this.hasAutocomplete = !0, e.registerSelectedItemWatcher(t.bind(this, function(e) {
    ...
    function() {
        function e(e, t, a, d, c) {
            function l(n, o) {
                ...
                var l = r("md-chips>*[md-chip-remove]") || m.remove,
                    s = r("md-chips>md-chip-template") || m["default"],
                ...
                return i[0].querySelector("md-chip-template>*[md-chip-remove]") && d.warn("invalid placement of md-chip-remove within md-chip-template."),
                    function(n, r, i, d) {
                        ...
                        var p = d[0];
                        if (p.chipContentsTemplate = s, p.chipRemoveTemplate = l, p.chipInputTemplate = u, r.attr({
                                ariaHidden: !0,
                                tabindex: -1
                            }).on("focus", function() {
                                p.onFocus()
        ...
        function e(e, t, n) {
            function o(o, r, i) {
                ...
                var c = i.alt || o.fontIcon || o.svgIcon || r.text(),
                    l = i.$normalize(i.$attr.mdSvgIcon || i.$attr.mdSvgSrc || "");
    ...
    function() {
        function e(e, o, r, i, a, d) {
            ...
            this.nestLevel = parseInt(o.mdNestLevel, 10) || 0, this.init = function(e, t) {
                t = t || {}, c = e, l = r[0].querySelector("[ng-click],[ng-mouseenter]"), this.isInMenuBar = t.isInMenuBar, this.nestedMenus = a.nodesToArray(c[0].querySelectorAll(".md-nested-menu")), this.enableHoverListener(), c.on("$mdInterimElementRemove", function() {
                    s.isOpen = !1
                })
            }, this.enableHoverListener = function() {
                i.$on("$mdMenuOpen", function(e, t) {
                    c[0].contains(t[0]) && (s.currentlyOpenMenu = t.controller("mdMenu"), s.isAlreadyOpening = !1, s.currentlyOpenMenu.registerContainerProxy(s.triggerContainerProxy.bind(s)))
                }), i.$on("$mdMenuClose", function(e, t) {
                    c[0].contains(t[0]) && (s.currentlyOpenMenu = n)
                });
                var e, o = t.element(a.nodesToArray(c[0].querySelectorAll("md-menu-item")));
                o.on("mouseenter", function(n) {
                    if (!s.isAlreadyOpening) {
                        var o = n.target.querySelector("md-menu") || a.getClosest(n.target, "MD-MENU");
                        e = d(function() {
                            if (o && (o = t.element(o).controller("mdMenu")), s.currentlyOpenMenu && s.currentlyOpenMenu != o) {
                                var e = s.nestLevel + 1;
                                s.currentlyOpenMenu.close(!0, {
                                    closeTo: e
                                })
                            } else o && !o.isOpen && o.open && (s.isAlreadyOpening = !0, o.open())
                        }, o ? 100 : 250);
                ...
                t && t.stopPropagation(), t && t.preventDefault(), s.isOpen || (s.isOpen = !0, l = l || (t ? t.target : r[0]), i.$emit("$mdMenuOpen", r), e.show({
                    scope: i,
                    mdMenuCtrl: s,
                    nestLevel: s.nestLevel,
                    element: c,
                    target: l,
                    preserveElement: s.isInMenuBar || s.nestedMenus.length > 0,
                    parent: s.isInMenuBar ? r : "body"
                }))
            }, i.$mdOpenMenu = this.open, i.$watch(function() {
                return s.isOpen
            }, function(e) {
                e ? (l.setAttribute("aria-expanded", "true"), r[0].classList.add("md-open"), t.forEach(s.nestedMenus, function(e) {
                    e.classList.remove("md-open")
                })) : (l && l.setAttribute("aria-expanded", "false"), r[0].classList.remove("md-open")), i.$mdMenuIsOpen = s.isOpen
                ...
                if (s.isOpen && (s.isOpen = !1, i.$emit("$mdMenuClose", r), e.hide(null, o), !n)) {
                    var a = s.restoreFocusTo || r.find("button")[0];
                    a instanceof t.element && (a = a[0]), a.focus()
                }
    ...
    function() {
        function e(e) {
            ...
            function r(e, o, r, i) {
                ...
                c.append(l), d && (o.append(c), c[0].style.display = "none"), a.init(c, {
                    isInMenuBar: d
                }), e.$on("$destroy", function() {
                    c.remove(), a.close()
                })
    ...
    function() {
        function e(e) {
            function o(e, o, a, d, c, l, s, m, u, h) {
                function p(n, o, r) {
                    return r.nestLevel ? t.noop : (r.disableParentScroll && !e.getClosest(r.target, "MD-DIALOG") ? r.restoreScroll = e.disableScrollAround(r.element, r.parent) : r.disableParentScroll = !1, r.hasBackdrop && (r.backdrop = e.createBackdrop(n, "md-menu-backdrop md-click-catcher"), u.enter(r.backdrop, r.parent)), function() {
                        r.backdrop && (r.backdrop.off("click"), u.leave(r.backdrop, {
                            duration: 0
                        })), r.disableParentScroll && r.restoreScroll()
                    })
                }

                function f(e, t, n) {
                    return n.cleanupInteraction(), n.cleanupResizing(), n.hideBackdrop(), m(t, {
                        addClass: "md-leave"
                    }).start().then(function() {
                ...
                function g(n, r, i) {
                    function d() {
                        return i.preserveElement ? r[0].style.display = "" : i.parent.append(r), l(function(e) {
                            var t = M(r, i);
                    ...
                    function f() {
                        function t(t) {
                            ...
                            switch (t.keyCode) {
                                case a.KEY_CODE.ESCAPE:
                                    ...
                                    break;
                                case a.KEY_CODE.UP_ARROW:
                                    b(t, i.menuContentEl, i, -1) || i.mdMenuCtrl.triggerContainerProxy(t), n = !0;
                                    break;
                                case a.KEY_CODE.DOWN_ARROW:
                                    b(t, i.menuContentEl, i, 1) || i.mdMenuCtrl.triggerContainerProxy(t), n = !0;
                                    break;
                        ...
                        var c = i.menuContentEl[0].querySelector("[md-menu-focus-target]") || i.menuContentEl[0].firstElementChild.querySelector("[tabindex]") || i.menuContentEl[0].firstElementChild.firstElementChild;
                        return c.focus(),
                            function() {
                ...
                function b(t, n, o, r) {
                    for (var i, a = e.getClosest(t.target, "MD-MENU-ITEM"), d = e.nodesToArray(n[0].children), c = d.indexOf(a), l = c + r; l >= 0 && l < d.length; l += r) {
                        var s = d[l].querySelector(".md-button");
                        if (i = E(s)) break
                    }
                    return i
                }
                ...
                function M(t, o) {
                    function r(e) {
                        e.top = Math.max(Math.min(e.top, M.bottom - u.offsetHeight), M.top), e.left = Math.max(Math.min(e.left, M.right - u.offsetWidth), M.left)
                    }

                    function a() {
                        for (var e = 0; e < h.children.length; ++e)
                            if ("none" != c.getComputedStyle(h.children[e]).display) return h.children[e]
                    }
                    var l, s, m, u = t[0],
                        h = t[0].firstElementChild,
                        p = h.getBoundingClientRect(),
                        f = d[0].body,
                        g = f.getBoundingClientRect(),
                        b = c.getComputedStyle(h),
                        E = o.target[0].querySelector("[md-menu-origin]") || o.target[0],
                        v = E.getBoundingClientRect(),
                        M = {
                            left: g.left + i,
                            top: Math.max(g.top, 0) + i,
                            bottom: Math.max(g.bottom, Math.max(g.top, 0) + g.height) - i,
                            right: g.right - i
                        },
                        $ = o.mdMenuCtrl.positionMode();
                    if ("target" == $.top || "target" == $.left || "target-right" == $.left) {
                        if (l = a(), !l) throw Error("Error positioning menu. No visible children.");
                        l = l.firstElementChild || l, l = l.querySelector("[md-menu-align-target]") || l, s = l.getBoundingClientRect(), m = {
                            top: parseFloat(u.style.top || 0),
                            left: parseFloat(u.style.left || 0)
                        }
                    }
                    var y = {},
                        C = "top ";
                    switch ($.top) {
                        case "target":
                            y.top = m.top + v.top - s.top;
                            break;
                        case "cascade":
                            y.top = v.top - parseFloat(b.paddingTop) - E.style.top;
                            break;
                        case "bottom":
                    ...
                    switch ($.left) {
                        case "target":
                            y.left = m.left + v.left - s.left, C += "left";
                            break;
                        case "target-right":
                            y.left = v.right - p.width + (p.right - s.right), C += "right";
                            break;
                        case "cascade":
                            var A = v.right + p.width < M.right;
                            y.left = A ? v.right - E.style.left : v.left - E.style.left - p.width, C += A ? "left" : "right";
                            break;
                        case "left":
                            y.left = v.left, C += "left";
                            break;
                        default:
                    ...
                    var k = Math.round(100 * Math.min(v.width / u.offsetWidth, 1)) / 100,
                        w = Math.round(100 * Math.min(v.height / u.offsetHeight, 1)) / 100;
                    return {
            ...
            var i = 8;
            return o.$inject = ["$mdUtil", "$mdTheming", "$mdConstant", "$document", "$window", "$q", "$$rAF", "$animateCss", "$animate", "$timeout"], e("$mdMenu").setDefaults({
                methods: ["target"],
                options: o
            })
        }
    ...
    function() {
        function e(e, n, o, r, i, a, d, c, l, s) {
            function m() {
                ae.selectedIndex = ae.selectedIndex || 0, u(), p(), h(), s(n), a.nextTick(function() {
            ...
            function u() {
                var e = c.$mdTabsTemplate,
                    n = t.element(ce.data);
                n.html(e), l(n.contents())(ae.parent), delete c.$mdTabsTemplate
            }
            ...
            function D() {
                e.$apply(function() {
                    ae.lastSelectedIndex = ae.selectedIndex, ae.offsetLeft = re(ae.offsetLeft), a.nextTick(ae.updateInkBarStyles, !1), a.nextTick(W)
                })
            }
            ...
            function z() {
                ...
                var e = Math.min(n.prop("clientWidth"), ae.maxTabWidth);
            ...
            function Q(e) {
                if (null == e && (e = ae.focusIndex), ce.tabs[e] && !ae.shouldCenterTabs) {
                    var t = ce.tabs[e],
                        n = t.offsetLeft,
                        o = t.offsetWidth + n;
                    ae.offsetLeft = Math.max(ae.offsetLeft, re(o - ce.canvas.clientWidth)), ae.offsetLeft = Math.min(ae.offsetLeft, re(n))
                }
            }
            ...
            function te() {
                ...
                if (!ae.tabs.length) return le.push(te);
            ...
            function ne() {
                ...
                if (!ae.tabs.length) return le.push(ae.updateInkBarStyles);
    ...
    function() {
        function e(e, t) {
            function n(n, o, r, i) {
                ...
                function d() {
                    i.enableDisconnect && t.disconnectScope(l)
                }

                function c() {
                    i.enableDisconnect && t.reconnectScope(l)
                }
                if (i) {
                    var l = i.enableDisconnect ? n.compileScope.$new() : n.compileScope;
                    return o.html(n.template), e(o.contents())(l), o.on("DOMSubtreeModified", function() {
