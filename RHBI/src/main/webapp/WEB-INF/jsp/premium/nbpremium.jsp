	...
	<div class="page">
		...
		<div class="card-body">
			<div class="card">
				...
				<div class="card-body">
				<form action="save_premium_form" method="POST"
						modelAttribute="premiumFormData">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="row form-group form-inline">
									...
									<div class="col-sm-8">
										<input required name="vehiclenumber1" id="Vehiclenumber"
								...
								<div class="row form-group form-inline">
									<label for="Policynumber" class="col-sm-4  control-label">
										Policy Number</label>
									<div class="col-sm-8 inner-addon right-addon">
										<input required name="policynumber" id="Policynumber"
								...
								<div class="row form-group form-inline">
									<label for="Policyexpirydate" class="col-sm-4  control-label">Policy
										Expiry Date</label>
									<div class="col-sm-8">
										<input required name="policyexpirydate" id="Policyexpirydate"
								...
								<div class="row form-group form-inline">
									...
									<div class="col-sm-8">
										<input required name="ncdeffectivedate" id="Ncdeffectivedate"
							...
							<div class="col-md-6">
								...
								<div class="row form-group form-inline">
									...
									<div class="col-sm-8">
										<input required name="policyeffectivedate"
					...
					<fieldset class="scheduler-border">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="row form-group form-inline">
									<label for="Voluntryexcessdiscount"
										class="col-sm-4  control-label">Voluntry Excess
										Discount RM</label>
									<div class="col-sm-8">
										<input required name="voluntryexcessdiscount"
											id="Voluntryexcessdiscount" class="form-control" type="text"
											value="${voluntryexcessdiscount}" />
									</div>
								</div>
								<div class="row form-group form-inline">
							...
							<div class="col-md-6">
								...
								<div class="row form-group form-inline">
									<label for="Fleetdiscount" class="col-sm-4  control-label">Fleet
										Discount RM</label>
									<div class="col-sm-8">
										<input required name="fleetdiscount" id="Fleetdiscount"
											class="form-control" type="text" value="${fleetdiscount}" />
									</div>
								</div>
								<div class="row form-group form-inline">
								...
								<div class="row form-group form-inline">
									<label for="Voluntryexcess" class="col-sm-4  control-label">Voluntary
										Excess %</label>
									<div class="col-sm-8">
										<input required name="voluntryexcess" id="Voluntryexcess"
											class="form-control" type="text" value="${voluntryexcess}" />
									</div>
									<label for="Voluntryexcessrm" class="col-sm-4  control-label">RM</label>
									<div class="col-sm-8">
										<input required name="voluntryexcessrm" id="Voluntryexcessrm"
											class="form-control" type="text" value="${voluntryexcessrm}" />
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-6">
								...
								<div class="row form-group form-inline">
									<label for="Mpapremium" class="col-sm-4  control-label">MPA
										Premium RM</label>
									<div class="col-sm-8">
										<input required name="mpapremium" id="Mpapremium"
								...
								<div class="row form-group form-inline">
									<label for="Gst1" class="col-sm-4  control-label">GST %
										%</label>
									<div class="col-sm-8">
										<input required name="gst1" id="Gst1" class="form-control"
											type="text" value="${gst1}" />
									</div>
									<label for="Gst1rm" class="col-sm-4  control-label">RM</label>
									<div class="col-sm-8">
										<input required name="gst1rm" id="Gst1rm" class="form-control"
								...
								<div class="row form-group form-inline">
									<label for="Amountpayableagent1"
										...
										Agent RM</label>
									<div class="col-sm-8">
										<input required name="amountpayableagent1"
							...
							<div class="col-md-6">
								...
								<div class="row form-group form-inline">
									<label for="Stampduty1" class="col-sm-4  control-label">Stamp
										Duty RM</label>
									<div class="col-sm-8">
										<input required name="stampduty1" id="Stampduty1" class="form-control" type="text"
											value="${stampduty1}" />
									</div>
								</div>
								<div class="row form-group form-inline">
									<label for="Commission1" class="col-sm-4  control-label">Commission
										% %</label>
									<div class="col-sm-8">
										<input required name="commission1" id="Commission1" class="form-control" type="text"
											value="${commission1}"/>
									</div>
									<label for="Commission1rm" class="col-sm-4  control-label">RM</label>
									<div class="col-sm-8">
										<input required name="commission1rm" id="Commission1rm" class="form-control" type="text"
											value="${commission1rm}" />
									</div>
								</div>
								<div class="row form-group form-inline">
									...
									<div class="col-sm-8">
										<input required name="amountpayableclient1" id="Amountpayableclient1" class="form-control" type="text"
					...
					<ul align="center" class="pager">
						<button onclick="location.href='nameddrivers'" type="button"
							class="btn btn-danger btn-md">Back</button>
						<button type="button" class="btn btn-primary btn-md">Save</button>
						<button type="button" class="btn btn-primary btn-md" onclick="location.href='nameddrivers'">Convert
							To Covernote</button>
